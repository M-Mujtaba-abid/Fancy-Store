...
export default async function RootLayout({
  ...
  // Footer ke category links ke liye. Server par yahan fetch karna zaroori hai
  // — Footer client component hai aur useEffect se laaye gaye links server
  // HTML mein nahi jate, jabke SEO ke liye unka wahin hona hi asal maqsad hai.
  //
    ...
    >
      ...
      >
        ...
        <Script id="google-analytics" strategy="lazyOnload">
          {`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-LL9B8YSG7L');`}
        </Script>
        ...
        <Script id="meta-pixel" strategy="lazyOnload">
          {`!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','2119855908881672');fbq('track','PageView');`}
        </Script>
        <noscript>
        ...
        <Script id="tiktok-pixel" strategy="lazyOnload">
          {`!function(w,d,t){w.TiktokAnalyticsObject=t;var ttq=w[t]=w[t]||[];ttq.methods=["page","track","identify","instances","debug","on","off","once","ready","alias","group","enableCookie","disableCookie","holdConsent","revokeConsent","grantConsent"],ttq.setAndDefer=function(t,e){t[e]=function(){t.push([e].concat(Array.prototype.slice.call(arguments,0)))}};for(var i=0;i<ttq.methods.length;i++)ttq.setAndDefer(ttq,ttq.methods[i]);ttq.instance=function(t){for(var e=ttq._i[t]||[],n=0;n<ttq.methods.length;n++)ttq.setAndDefer(e,ttq.methods[n]);return e},ttq.load=function(e,n){var r="https://analytics.tiktok.com/i18n/pixel/events.js",o=n&&n.partner;ttq._i=ttq._i||{},ttq._i[e]=[],ttq._i[e]._u=r,ttq._t=ttq._t||{},ttq._t[e]=+new Date,ttq._o=ttq._o||{},ttq._o[e]=n||{};n=document.createElement("script");n.type="text/javascript",n.async=!0,n.src=r+"?sdkid="+e+"&lib="+t;e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(n,e)};ttq.load('D8FSN2JC77U5P5NBO52G');ttq.page()}(window,document,'ttq');`}
        </Script>
        <Providers>
          {/* Promoter ke link (?ref=CODE) se aaya coupon yaad rakh leta hai.
              Yahan root par hai kyunke link kisi bhi page par khul sakta hai
              (home, product, category), sirf checkout par nahi. Kuch render
              nahi karta. */}
          <CouponRefCapture />
          <AppShell footerCategories={footerCategories}>{children}</AppShell>
          <FloatingWidgets />
        </Providers>
        <Toaster position="top-right" />
      </body>
