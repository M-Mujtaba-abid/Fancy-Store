        ...
        <nav className="space-y-3 flex-1 overflow-y-auto custom-scrollbar pr-2">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <ChevronDown
                size={16}
                className={`${openProducts ? "rotate-180" : ""} transition-transform`}
              />
            </button>
            {openProducts && (
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <ChevronDown
                size={16}
                className={`${openReview ? "rotate-180" : ""} transition-transform`}
              />
            </button>
            {openReview && (
              <div className="pl-4 space-y-1">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <ChevronDown
                size={16}
                className={`${openOrders ? "rotate-180" : ""} transition-transform`}
              />
            </button>
            {openOrders && (
              <div className="pl-4 space-y-1">
