...
//   Star,
//   PackageX,
// } from "lucide-react"; // ChevronLeft aur ChevronRight hata diye kyunke ab unki zaroorat nahi
...
// // ✅ Apna naya Pagination component import karein (Path apne hisaab se adjust kar lein)
...
//           {/* Filter Tabs */}
//           <div className="flex bg-card p-1 rounded-full self-center floating-card border border-border/50">
//             {categories.map((cat) => (
//               <button
//                 key={cat}
//                 onClick={() => {
...
//               // Stock check yahan verify karein
...
//         {/* ✅ Alag kiya hua Pagination Component yahan add kar diya */}
//         {data?.totalPages > 1 && (
