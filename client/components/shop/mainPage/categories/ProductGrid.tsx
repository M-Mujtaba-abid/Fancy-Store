...
import Loading from "@/app/loading";
import { Pagination } from "../../share/Pagination";
// ✅ Apna SEO optimized ProductCard import karein!
import ProductCard from "../../share/ProductCard";

// ✅ Apni categories import karein
import { HOME_CATEGORIES } from "@/constants/categoriesData";
...
const ProductGrid = () => {
  ...
  // ⚠️ IDEAL SCENARIO: Aapke hook ko activeTab pass hona chahiye taake backend se hi filter ho kar aaye
          ...
          <AnimatePresence mode="popLayout">
            {filteredProducts.map((product: any) => (
              <motion.div
                ...
                className="h-full"
              >
                {/* ✅ Humne yahan apna reusable component laga diya */}
                <ProductCard
                  {...product}
                  variant="overlay"
