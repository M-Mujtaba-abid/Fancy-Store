...
const WhatsAppWidget = () => {
  ...
  const phoneNumber = "923334140461"; 
  ...
  return (
    ...
    <div className="fixed bottom-[136px] md:bottom-28 right-4 md:right-8 z-50">
      <Link
        ...
        // ✅ Unified sizes to perfectly match ChatWidget
        className="h-9 w-9 sm:h-12 sm:w-12 md:h-14 md:w-14 rounded-full bg-[#25D366] text-white shadow-xl flex items-center justify-center hover:scale-110 transition-transform duration-300"
        aria-label="Chat on WhatsApp"
      >
        {/* ✅ WhatsApp ka Authentic Icon (SVG) */}
        <svg
