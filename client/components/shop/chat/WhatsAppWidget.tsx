  ...
  return (
    <div className="relative">
      <Link
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-green-500 p-2.5 text-white shadow-lg transition-all hover:scale-110 hover:bg-green-600 hover:shadow-xl sm:h-14 sm:w-14 sm:p-3.5"
