...
// NOTE:
// This file is intentionally kept as commented legacy code.
// Sidebar routing has been moved to:
// `app/(admin)/dashboard/_components/SidebarNav.tsx`
// to support route-driven rendering in the dashboard layout.